...
### 🤖 AI Integration
- **AI Chat Assistant**: Powered by the Hugging Face Inference API for intelligent responses
- **Default model**: The server uses `moonshotai/Kimi-K2-Thinking:novita` by default for the school assistant. You can override this by setting the `HF_MODEL` (or `HUGGINGFACE_MODEL`) environment variable.
...
4. **Environment Configuration**
   ...
   # Recommended default model for the school chatbot. The server will use this model
   # unless you set HF_MODEL (or HUGGINGFACE_MODEL) in your environment.
