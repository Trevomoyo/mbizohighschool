// API Configuration
// Production live API base (Render):
const API_BASE = 'https://mbizohighschool.onrender.com/api';
// If you want to use a relative path (same origin) instead, you can switch to:
