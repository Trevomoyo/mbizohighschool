...
app.post('/api/chat', async (req, res) => {
    ...
    // Choose HF model via env or default to the recommended school assistant model
    // By default we use the `moonshotai/Kimi-K2-Thinking:novita` model as requested.
    // You can override by setting HF_MODEL or HUGGINGFACE_MODEL in your environment.
    const hfModel = process.env.HF_MODEL || process.env.HUGGINGFACE_MODEL || 'moonshotai/Kimi-K2-Thinking:novita';    
    ...
    const hfUrl = process.env.HF_ROUTER_URL || 'https://router.huggingface.co/v1';
    console.log('Calling Hugging Face router:', hfUrl, 'model:', hfModel);
